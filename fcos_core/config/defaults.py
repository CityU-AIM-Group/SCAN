...
_C.MODEL.MIDDLE_HEAD.NODE_LOSS_WEIGHT = 1.0
_C.MODEL.MIDDLE_HEAD.ACT_LOSS_WEIGHT = 1.0
_C.MODEL.MIDDLE_HEAD.OT_LOSS_WEIGHT = 1.0
...
_C.MODEL.MIDDLE_HEAD.WITH_SELF_TRAINING = False
...
_C.MODEL.MIDDLE_HEAD.SUB_SAMPLING = 'random'

_C.MODEL.MIDDLE_HEAD.NUM_POS_POINTS_SOURCE = 100
_C.MODEL.MIDDLE_HEAD.NUM_POS_POINTS_TARGET = 20
_C.MODEL.MIDDLE_HEAD.WITH_OT = False
_C.MODEL.MIDDLE_HEAD.UPDATE_BANK_ITER = 1
_C.MODEL.MIDDLE_HEAD.ATT_VERSION = 'v2'
_C.MODEL.MIDDLE_HEAD.WITH_ADAPTIVE_SELF_TRAINING = False